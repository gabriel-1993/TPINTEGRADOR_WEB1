document.addEventListener("DOMContentLoaded", () => {
    ...
    // FALTA SOLO LA PARTE DE REGISTRO FALTA SOLO LA PARTE DE REGISTRO FALTA SOLO LA PARTE DE REGISTRO FALTA SOLO LA PARTE DE REGISTRO 
    ...
    registroForm.addEventListener("submit", function (event) {
        ...
        if (!expNom.test(usuario)) {
            ...
            errores.push("El usuario puede combinar letras y números, mínimo 6 caracteres y máximo 12.");
        ...
        if (password === "" || passwordConfirmar === "") {
            // msj de error pass vacio
            errores.push("Por favor, ingrese el password y luego la confirmacíon.");
            passwordRegistroCumple = false;

        } if (password !== passwordConfirmar) {
            errores.push("Por favor, ingrese el mismo password en confirmación.");
            passwordRegistroCumple = false;
        }
        if (!passwordExp.test(password)) {
        ...
        if (correo === "") {
            ...
            errores.push("Email: campo obligatorio. Por favor, ingrese un Email.");
           correoCumple = false;
